        ...
        while True:
            try:
                ...
                if f_move == "ROT":
                    ...
                    mov_delay = 400
                    move_dir = f_move.lower()
                    print("moving", move_dir)
                    print(move(shape_blcks, move_dir))   
                    draw_shape(shape_blcks)
...
def draw_shape(shp_blcks):
    '''this draws list of blocks or a block to the background and blits background to screen'''
